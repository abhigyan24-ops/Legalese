...
const LESSON_PLANS = [
  ...
  },
  {
    ...
    title: 'Right to Equality & Non-Discrimination (Articles 14, 15 & 17)',
    icon: '⚖️',
    gradeLevel: 'Classes 5 to 10 (Ages 10–16)',
    duration: '45 minutes',
    lawCite: 'Constitution of India Articles 14, 15 & 17; Protection of Civil Rights Act 1955',
    summary:
      'Article 14 guarantees equality before the law, Article 15 prohibits discrimination on grounds of religion, race, caste, sex or place of birth in public spaces, and Article 17 abolishes untouchability in all forms. Every child possesses equal dignity and equal opportunity.',
    discussionQuestions: [
      'How did Kabir and his teammates stand together when they faced unfair treatment at the sports tournament?',
      'Why does the Constitution prohibit discrimination in public spaces like water stations, parks, and schools?',
      'What does "Fraternity and Equal Dignity" mean in your everyday classroom or playground?',
    ],
    extensionActivity: {
      title: 'The Classroom Equality Charter',
      desc: 'Students collaboratively draft a 5-point "Playground & Classroom Equality Charter" ensuring fair access to sports equipment, group roles, and equal encouragement for every student.',
    },
  },
];
